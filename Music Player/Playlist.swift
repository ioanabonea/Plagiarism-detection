...
class Playlist: UITableViewController, UISearchResultsUpdating, PlaylistDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if resultSearchController.isActive && resultSearchController.searchBar.text != "" {
           print(filteredSongs[indexPath.row] as AnyObject)
    ...
    @IBAction func selectPressed() {
        ...
        if tableView.indexPathsForSelectedRows!.count == 2{
            let firstIndex = tableView.indexPathsForSelectedRows![0]
            let secondIndex = tableView.indexPathsForSelectedRows![1]
            
            let firstObjectRow = x[firstIndex.row]
            let secondObjectRow = x[secondIndex.row]
            ...
            self.firstSongURL = firstSongUrl
            self.secondSongURL = secondSongUrl
            ...
            let alert = UIAlertController(title: "Not allowed.", message: "Please select 2 songs.", preferredStyle: .alert)
